...
# parser.add_argument('--arg_2',  required=True, type=int)
#
...
# # https://github.com/renansantosmendes/ml_datasets
#
# args = parser.parse_args()
#
...
df = pd.read_csv(os.path.join(os.getcwd(), 'data', args.data_file_name), sep=',', encoding='utf-8')
print(df)
